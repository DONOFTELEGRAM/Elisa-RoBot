...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        reply = (
            f"<code></code><r>Another person whacked by a banhammer...!</r>\n"
            f"<code></code><r>Banned:</r> {mention_html(member.user.id, html.escape(member.user.first_name))}"
        )
        if reason:
            reply += f"\n<code></code><r>Reason:</r> \n{html.escape(reason)}"
